      ...
      for (size_t i = 1; i < opNum; i++) {
        ...
        if (nameStr == "llvm.loop.name") {
          ...
          state.addAttribute(nameStr,
                             builder.getStringAttr(loopName->getString()));
          ...
          // The original code was licensed with Apache.
                       ...
                       .count(nameStr)) {
          state.addAttribute(nameStr,
                             builder.getI32IntegerAttr(getIntegerOperand(1)));
          ...
          state.addAttribute(
              nameStr, builder.getArrayAttr(
                           {builder.getI32IntegerAttr(getIntegerOperand(1)),
                            builder.getIntegerAttr(builder.getI1Type(),
                                                   getIntegerOperand(2)),
                            builder.getI8IntegerAttr(getIntegerOperand(3))}));

        } else if (nameStr == "llvm.loop.latency") {
          state.addAttribute(
              nameStr, builder.getArrayAttr(
                           {builder.getI32IntegerAttr(getIntegerOperand(1)),
                            builder.getI32IntegerAttr(getIntegerOperand(2))}));
          ...
          state.addAttribute(
              nameStr, builder.getArrayAttr(
                           {builder.getI32IntegerAttr(getIntegerOperand(1)),
                            builder.getI32IntegerAttr(getIntegerOperand(2)),
                            builder.getI32IntegerAttr(getIntegerOperand(3))}));

        } else {
          state.addAttribute(subName->getString(), builder.getUnitAttr());
        }
      }
    }
